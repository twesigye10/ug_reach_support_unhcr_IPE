...
# output analysis
write_csv(full_analysis_long, paste0("outputs/", butteR::date_file_prefix(), "_analysis_lf_ipe_hh_sampled_energy_land.csv"), na="")
