...
# dap
dap <- read_csv("inputs/r_dap_ipe_sampled_filtered.csv")
...
write_csv(full_analysis_long %>% select(-select_type),
          paste0("outputs/", butteR::date_file_prefix(), "_full_analysis_lf_ipe_hh_sampled_filtered.csv"), na="")
write_csv(full_analysis_long, paste0("outputs/full_analysis_lf_ipe_hh_sampled_filtered.csv"), na="")